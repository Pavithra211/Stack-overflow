      ...
      <div className='ask-question'>
        <div className='ask-ques-container'>
            ...
            <div className='ask-form-container'>
                ...
                <input type='text' id='ask-ques-title'  onChange = {(e) => {setQuestionTitle(e.target.value) }}  placeholder='e.g. Is there an R function for finding the index of an element in avector'/>
                </label>
